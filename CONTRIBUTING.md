# Contributing to delirium-risk-predictor

Thanks for your interest in contributing to the delirium-risk-predictor!
...
For python code style, we recommend the [PEP 8 style guide](https://peps.python.org/pep-0008/).

For JS we use [ESLint](https://eslint.org/).
